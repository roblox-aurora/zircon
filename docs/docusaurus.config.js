...
const config = {
  ...
  favicon: 'img/logo_small.svg',
  organizationName: 'roblox-aurora', // Usually your GitHub org/user name.
  projectName: 'zircon', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: 'https://github.com/roblox-aurora/zircon/edit/main/docs/',
        },
        theme: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/roblox-aurora/zircon',
            label: 'GitHub',
            position: 'right',
          },
        ],
